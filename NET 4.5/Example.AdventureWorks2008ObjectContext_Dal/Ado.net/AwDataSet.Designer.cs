    ...
    public partial class ProductCategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"
                      INSERT INTO [SalesLT].[ProductCategory] ([ParentProductCategoryID], [Name], [rowguid], [ModifiedDate]) VALUES (@ParentProductCategoryID, @Name, @rowguid, @ModifiedDate);
            ...
            this._adapter.UpdateCommand.CommandText = @"
                      UPDATE [SalesLT].[ProductCategory] SET [ParentProductCategoryID] = @ParentProductCategoryID, [Name] = @Name, [rowguid] = @rowguid, [ModifiedDate] = @ModifiedDate WHERE (([ProductCategoryID] = @Original_ProductCategoryID) AND ((@IsNull_ParentProductCategoryID = 1 AND [ParentProductCategoryID] IS NULL) OR ([ParentProductCategoryID] = @Original_ParentProductCategoryID)) AND ([Name] = @Original_Name) AND ([rowguid] = @Original_rowguid) AND ([ModifiedDate] = @Original_ModifiedDate));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "\r\n                      SELECT        SalesLT.ProductCategory.*\r\n                " +
                "      FROM            SalesLT.ProductCategory\r\n                      WHERE      " +
                "  (Name LIKE N\'%\' + @categoryName + N\'%\')\r\n                    ";
